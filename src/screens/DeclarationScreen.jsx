      ...
      {burst && (
        <div style={{
          ...
          background: isHumanWin
            ? 'radial-gradient(ellipse at center, rgba(255,79,163,0.35) 0%, transparent 65%)'
            : 'radial-gradient(ellipse at center, rgba(79,203,255,0.15) 0%, transparent 65%)',
        ...
        <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none', overflow: 'hidden' }}>
          {Array.from({ length: 20 }).map((_, i) => (
            <div key={i} style={{
              ...
              top: `${Math.random() * 100}%`,
              width: 6, height: 6,
              background: i % 2 === 0 ? '#FF4FA3' : '#FF7A45',
              borderRadius: '50%',
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <h1 style={{
            ...
            fontWeight: 700,
            color: isHumanWin ? '#FF4FA3' : 'rgba(255,255,255,0.92)',
            textShadow: isHumanWin ? '0 0 30px rgba(255,79,163,0.5)' : 'none',
            lineHeight: 1.1,
          }}>
          ...
          {winningHand && (
            <div style={{
              fontSize: 16, color: '#FF4FA3', fontFamily: 'Playfair Display, serif',
              marginTop: 4,
            }}>
              {winningHand.pattern}
            </div>
        ...
        {isHumanWin && winnerPlayer.hand.length > 0 && (
          <div style={{
            ...
            <div style={{ fontSize: 11, color: '#FF4FA3', fontFamily: 'Nunito', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 10 }}>
              Winning Hand
            </div>
            ...
            {winningHand && (
              <div style={{ marginTop: 10, textAlign: 'center' }}>
                <span style={{ fontSize: 22, fontWeight: 800, color: '#FF4FA3', fontFamily: 'Playfair Display, serif' }}>
